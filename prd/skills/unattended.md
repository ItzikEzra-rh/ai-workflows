...
This workflow reuses the individual phase skills (`ingest.md`, `clarify.md`,
`draft.md`) but orchestrates them with self-resolution and self-review loops
...
|-------|-------|------------|-------------|
| 1 | Ingest | `ingest.md` | `01-requirements.md` written |
...
| 4 | Self-Clarify | `clarify.md` *(overridden)* | `02-clarifications.md` written |
| 5 | Draft | `draft.md` *(overridden)* | `03-prd.md` written |
...
Read and follow `ingest.md` with these overrides:
...
2. Run the gap analysis from `clarify.md` Step 2 — analyze requirements
...
Read and follow `draft.md` with these overrides:
